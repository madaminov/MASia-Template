  ...
  return (function () {
    ...
    var i = {
      ...
      s = {
        ...
        fixedHeight: !1,
        prevHtml:
          '<svg><path fill-rule="evenodd" clip-rule="evenodd" d="M12.0607 16.0607L11 15L6 20L11 25L12.0607 23.9393L8.12132 20L12.0607 16.0607Z" fill="black"/></svg>',
        nextHtml:
          '<svg><path d="M10.9982 15L15.9982 20L10.9982 25L9.9375 23.9393L13.8768 20L9.9375 16.0607L10.9982 15Z"/></svg>',
        navTitles: {
          days: 'MMMM, <i>yyyy</i>',
          months: 'yyyy',
          years: 'yyyy1 - yyyy2',
    ...
    class C {
      ...
      _handleRangeStatus() {
        ...
        let o = u({
          '-in-range-':
            n && r && ((h = this.date), (l = n), (d = r), m(h, l) && v(h, d)),
    ...
    class V {
      ...
      _buildBaseHtml() {
        let { prevHtml: e, nextHtml: t } = this.opts;
        this.$el.innerHTML = `<div class="datepicker-icon"></div><div class="air-datepicker-nav--action" data-action="prev">${e}</div><div class="air-datepicker-nav--title"></div><div class="air-datepicker-nav--action" data-action="next">${t}</div><div class="wrap-week"><button id="prevWeek">${e}</button><button id="nextWeek">${t}</button></div>`;
      }
      get isNavIsFunction() {
    ...
    class R {
      ...
      init() {
        ...
        (!B || (B && P && !h.contains(P))) &&
          ...
          this.elIsInput &&
            (i || this._bindEvents(),
            r && !o && (this.keyboardNav = new A({ dp: this, opts: e }))),
